...
import { Users, Trophy, ArrowRight, Eye, Coins,Trash2 } from "lucide-react";
...
export const ContestCard = ({ contest, onJoin, onDelete, onReview, isCreator = false, currentUserId, hasJoined = false }: ContestCardProps) => {
  ...
  const showJoinButton = !hasJoined && !isCreator && contest.status === 'open' && !isFull;
  const showReviewButton = hasJoined;
